...
values."
  ...
  (setq-default
   ...
   ;; start. (default nil)
   dotspacemacs-auto-resume-layouts t ;; My change later, just want to see if I like it
   ...
   dotspacemacs-enable-paste-transient-state t ;; May be a funky chane that I don't like, we'll see
